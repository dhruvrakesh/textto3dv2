-- Phase 1: Job Deletion and Management Functions
...
BEGIN
  ...
  RAISE LOG 'Cleaned up % stuck jobs', cleaned_count;
...
-- 6. Create a scheduled cleanup job using pg_cron (runs every 15 minutes)
SELECT cron.schedule(
  'cleanup-stuck-jobs',
  '*/15 * * * *', -- Every 15 minutes
  'SELECT t3d.cleanup_stuck_jobs();'
);