-- Revert RPC functions to accept explicit user_id parameter
...
-- Update retry_job function to accept explicit user_id parameter
...
-- Update bulk_delete_jobs function to work with two-parameter delete function
...
BEGIN
  ...
  FOREACH v_job_id IN ARRAY p_job_ids LOOP
    BEGIN
      IF t3d.delete_job(v_job_id, p_user_id) THEN
